      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-wrap gap-2">
            <Button
              onClick={() =>
                testEndpoint("/laravel-api/dashboard/stats", "Dashboard Stats")
              }
              disabled={loading}
            >
            ...
            <Button
              onClick={() =>
                testEndpoint("/laravel-api/equipment", "Equipment")
              }
              disabled={loading}
            >
              Test Equipment
            ...
            <Button
              onClick={() =>
                testEndpoint("/laravel-api/contracts", "Contracts")
              }
              disabled={loading}
            >
              Test Contracts
            ...
            <Button
              onClick={() =>
                testEndpoint(
                  "http://192.168.126.143:8000/api/dashboard/stats",
                  "Direct Laravel API",
                )
              }
              disabled={loading}
            ...
            <Button onClick={() => setTestResult("")} variant="outline">
              Clear
            </Button>
          </div>
            ...
            <p>
              ...
              {import.meta.env.DEV
                ...
                : import.meta.env.VITE_API_URL ||
                  "http://192.168.126.143:8000/api"}
            </p>
            <p>
              <strong>Laravel Target:</strong> http://192.168.126.143:8000/api
            </p>
          </div>
        </CardContent>
      </Card>
