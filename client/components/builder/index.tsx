...
export const CardTitleWrapper = ({ text, className, ...props }: { text?: string; className?: string }) => (
  <CardTitle className={className} {...props}>
    {text}
  </CardTitle>
);

export const CardDescriptionWrapper = ({ text, className, ...props }: { text?: string; className?: string }) => (
